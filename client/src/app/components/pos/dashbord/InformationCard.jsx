...
const InformationCard = ({ icon, title, description }) => {
  return (
    <div className="bg-white p-4 rounded-2xl shadow-md hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300 cursor-pointer h-40 w-full flex">
      {/* flex container to align icon and content vertically */}
      <div className="flex items-center space-x-4 w-full">
        ...
        <div className="flex-1 flex flex-col justify-center overflow-hidden">
          <h2 className="text-lg sm:text-xl font-bold mb-1 text-gray-800 truncate">
            {title}
          </h2>
